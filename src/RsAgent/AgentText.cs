...
namespace RsAgent
{
    internal static class AgentText
    {
        ...
        private static readonly Dictionary<string, string> Spanish = Build(new[]
        {
            ...
            "rsm.disconnectResponseInvalid", "Firulai devolvio una respuesta de desconexion no valida: {0}",
        ...
        private static readonly Dictionary<string, string> Catalan = Build(new[]
        {
            ...
            "rsm.disconnectResponseInvalid", "Firulai ha retornat una resposta de desconnexio no valida: {0}",
        ...
        private static readonly Dictionary<string, string> Basque = Build(new[]
        {
            ...
            "rsm.disconnectResponseInvalid", "Firulaik deskonexio-erantzun baliogabea itzuli du: {0}",
        ...
        private static readonly Dictionary<string, string> Galician = Build(new[]
        {
            ...
            "rsm.disconnectResponseInvalid", "Firulai devolveu unha resposta de desconexion non valida: {0}",
        ...
        private static readonly Dictionary<string, string> French = Build(new[]
        {
            ...
            "rsm.disconnectResponseInvalid", "Firulai a renvoye une reponse de deconnexion non valide : {0}",
        ...
        private static readonly Dictionary<string, string> German = Build(new[]
        {
            ...
            "rsm.disconnectResponseInvalid", "Firulai hat eine ungueltige Trennungsantwort zurueckgegeben: {0}",
        ...
        private static readonly Dictionary<string, string> Italian = Build(new[]
        {
            ...
            "rsm.disconnectResponseInvalid", "Firulai ha restituito una risposta di disconnessione non valida: {0}",
        ...
        private static readonly Dictionary<string, string> Japanese = Build(new[]
        {
            ...
            "rsm.disconnectResponseInvalid", "Firulai から無効な切断応答が返されました: {0}",
        ...
        private static readonly Dictionary<string, string> Chinese = Build(new[]
        {
            ...
            "rsm.disconnectResponseInvalid", "Firulai 返回了无效的断开连接响应: {0}",
